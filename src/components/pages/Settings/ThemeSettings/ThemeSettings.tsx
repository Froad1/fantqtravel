...
const ThemeSettings = () => {
    ...
    return (
        <div className={classes.theme_page_container}>
            ...
            <div className={classes.theme_select}>
                <div onClick={changeTheme} className={`${classes.theme} ${ darkTheme && classes.selected}`}>
                    Темна
